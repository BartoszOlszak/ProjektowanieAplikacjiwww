...
<body onload="startclock()">
    <div id="menu">
        ...
        <h6>Budowle</h6>
        <a href="html/dom.html"><p>Dom Czarodzieja</p></a>
        <a href="html/zamek.html"><p>Zamek</p></a>
        <a href="html/samochod.html"><p>Samochód</p></a>
    ...
    <div id="container">
        ...
        <nav>
            <a href="html/index.html"><div class="tile">Strona Główna</div></a>
            <a href="html/serwer.html"><div class="tile">Serwer</div></a>
            <a href="html/dom.html"><div class="tile">Budowle</div></a>
            <a href="html/informacje.html"><div class="tile">Informacje</div></a>
            <a href="html/kontakt.html"><div class="tile">Kontakt</div></a>
        </nav>
        <div style="clear: both;"></div>
        
        <main>
            <img src="Images/minecraft.jfif">
            <h3>Strona o budowlach Minecraft</h3>
            <p>To jest strona o budowlach minecraft</p>
        </main>

        <main>
            <img src="Images/shrek.jfif">
            <h3>Shrek</h3>
            <p>Będzie też skrypt do Shreka bo czemu nie</p>
        </main>
        <div style="clear: both;"></div>
    </div>
    <div style="clear: both;"></div>
